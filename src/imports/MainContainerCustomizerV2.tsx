import svgPaths from "./svg-mw6efausdf";
...
import img1 from "figma:asset/ee516c006ce84ea2dba7d3f3d0aeea92702e6194.png";
import img2 from "figma:asset/752d72ab1583c009d40e63d0f8b0567605a8077f.png";
import img3 from "figma:asset/81fd7c5365f8545cfb7aec0561623846700aab46.png";
import img4 from "figma:asset/40ff1ff1bbc23afbeea715d1a7ad83f92e00bd37.png";
...
function ProductImage() {
  return (
    <div className="[grid-area:1_/_1] h-[459.838px] ml-0 mt-0 relative w-[384.679px]" data-name="Product Image">
      <div className="absolute h-[443.587px] left-[3.05px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[381.632px_443.587px] opacity-0 top-0 w-[381.633px]" data-name="Spider COLOR" style={{ maskImage: `url('${imgSpiderColor}')` }}>
      ...
      <div className="absolute h-[443.587px] left-[3.05px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[381.632px_443.587px] top-0 w-[381.633px]" data-name="Spider Cream" style={{ maskImage: `url('${imgSpiderColor}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgSpiderCream} />
      </div>
      <div className="absolute bg-[#2458a6] h-[454px] left-[-8px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[11.047px_5.162px] mask-size-[381.632px_443.587px] mix-blend-multiply opacity-0 top-[-5.16px] w-[397px]" style={{ maskImage: `url('${imgSpiderColor}')` }} />
    </div>
  );
}
...
function MicBottomPartDiv() {
  return (
    <div className="absolute h-[701.177px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[205px_701.177px] overflow-clip top-0 w-[205px]" data-name="mic-bottom-part-div" style={{ maskImage: `url('${img}')` }}>
      ...
      <div className="absolute bg-[rgba(255,234,0,0)] h-[120.051px] left-0 mix-blend-multiply top-[593.94px] w-[205px]" data-name="mic-top-bottom-parts-div-for-color-overlay-with-muliply" />
    </div>
  );
}
...
function MicMidPartDiv() {
  return (
    <div className="absolute h-[701.177px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[205px_701.177px] overflow-clip top-0 w-[205px]" data-name="mic-mid-part-div" style={{ maskImage: `url('${img}')` }}>
      ...
      <div className="absolute bg-[rgba(246,139,227,0)] h-[264.675px] left-[18.95px] mix-blend-multiply top-[329.26px] w-[166.738px]" data-name="mic-body-div-for-color-overlay-with-muliply" />
    </div>
  );
}
...
function MicTopPartDiv() {
  return (
    <div className="absolute h-[701.177px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[205px_701.177px] overflow-clip top-0 w-[205px]" data-name="mic-top-part-div" style={{ maskImage: `url('${img}')` }}>
      ...
      <div className="absolute bg-[rgba(255,234,0,0)] h-[329.264px] left-0 mix-blend-multiply top-0 w-[205px]" data-name="mic-top-bottom-parts-div-for-color-overlay-with-muliply" />
    </div>
  );
}
  ...
  return (
    <div className="absolute bottom-[106px] content-stretch flex h-[936px] items-end justify-between left-[215px] right-[373px]" data-name="Product Display">
      ...
      <div className="h-[701.177px] overflow-clip relative shrink-0 w-[205px]" data-name="output-microphone-variation-for-color-picker">
        ...
        <div className="absolute h-[138.129px] left-[33px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-32.999px_-10.574px] mask-size-[205px_701.177px] opacity-0 top-[10.57px] w-[137.949px]" data-name="microphone-grill-image-always-on-top-z-index" style={{ maskImage: `url('${img}')` }}>
            ...
            <div className="flex-none rotate-[359.365deg]">
              <div className="h-[214.101px] relative w-[77.978px]" data-name="017 1">
                <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
                  ...
                  <div className="absolute bg-[#e2dbd2] inset-0 mix-blend-overlay" />
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="absolute left-[3.26px] size-[30px] top-[3.75px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g clipPath="url(#clip0_2011_1424)" id="Layer_1">
          <path d={svgPaths.p2c2dae80} fill="var(--fill-0, #51782A)" id="Vector" />
          <path d={svgPaths.p2c768b00} fill="var(--fill-0, #51782A)" id="Vector_2" />
          <path d={svgPaths.p20d9c680} fill="var(--fill-0, #51782A)" id="Vector_3" />
        </g>
        <defs>
          <clipPath id="clip0_2011_1424">
...
function Container2() {
  return (
    <div className="basis-0 content-stretch flex gap-[20px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="relative rounded-[600px] shrink-0 size-[49px]" data-name="Texture Choose">
        <div aria-hidden="true" className="absolute border-2 border-[#51782a] border-solid inset-0 pointer-events-none rounded-[600px]" />
...
function Container4() {
  return (
    <div className="basis-0 content-stretch flex gap-[20px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="relative rounded-[600px] shrink-0 size-[49px]" data-name="Texture Choose">
        <div aria-hidden="true" className="absolute border-2 border-[#e2dbd2] border-solid inset-0 pointer-events-none rounded-[600px]" />
...
export default function MainContainerCustomizerV2() {
  return (
    <div className="bg-[#f4e9dc] relative size-full" data-name="Main Container-customizer-v2">
      <ProductDisplayContainer />
      <Menu4 />
      <div className="absolute bg-[#faf5ef] bottom-[2px] box-border content-stretch flex gap-[20px] items-center justify-center left-[calc(62.5%-25.404px)] p-[30px] rounded-tl-[15px] rounded-tr-[15px] translate-x-[-50%]" data-name="Disclaimer Container">
